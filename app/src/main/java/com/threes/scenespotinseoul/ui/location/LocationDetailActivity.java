                      ...
                      v -> {
                        ...
                        mLocation_simpleText.setVisibility(View.GONE);
                                ...
                                for (i = 0; i < hashtagSpans.size(); i++) {
                                    ...
                                    jhashTag.setOnClickEventListener(new Hashtag.ClickEventListener() {
                                        @Override
                                        public void onClickEvent(String data) {
                                            Log.e("result.info", data);
                                            Intent intent = new Intent(LocationDetailActivity.this, SearchActivity.class);
                                ...
                                TextView tags_view = findViewById(R.id.location_hash_tag);
                                if (tags_view != null) {
